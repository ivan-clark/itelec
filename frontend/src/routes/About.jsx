    ...
    return (
        <>
            <div className="about-container">
                ...
                <img src="#" alt="About Us" className="about-image" />
                <br></br>
